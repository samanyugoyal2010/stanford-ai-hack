...
function renderHeartScene() {
  ...
  const heartMaterial = new THREE.MeshPhysicalMaterial({ color: '#9f3445', roughness: .28, metalness: .02, clearcoat: .45, clearcoatRoughness: .2 });
  ...
  chamber(-.47, .42, .67, '#5c8cbd', [.78, .62, .2]); chamber(.47, .42, .67, '#c75a58', [.78, .62, .2]); chamber(-.47, -.42, .72, '#4776aa', [.92, 1.02, .22]); chamber(.47, -.42, .72, '#b8424b', [.92, 1.02, .22]);
  ...
  const valve = new THREE.Mesh(new THREE.TorusGeometry(.17, .06, 16, 32), new THREE.MeshPhysicalMaterial({ color: '#e8b66b', roughness: .25, clearcoat: .4 })); valve.position.set(0, -.05, 1.04); valve.rotation.x = Math.PI / 2; group.add(valve);
